<<<<<<< Updated upstream:src/Hanoi.java
import util.Stack;
...
/**
 * Classe permettant la résolution du problème des tours d'Hanoi.
 *
 * @author Forestier Quentin, Herzig Melvyn
 * @version 18.11.2020
 */
>>>>>>> Stashed changes:src/hanoi/Hanoi.java
public class Hanoi
{
...
=======
     ...
     * @return Tableau de tableaux de int contenant l'état des aiguilles.
     */
    public int[][] status()
    {
        int[][] t = new int[3][];
    ...
    /**
     * Permet de savoir si tous les disques sont sur la troisième aiguille.
...
>>>>>>> Stashed changes:src/hanoi/Hanoi.java
    ...
    /**
     * Convertit l'objet Hanoi en chaine de caractère
     * @return
     */
    @Override
